...
/**
 * Created by victorwong on 2017-09-03.
 */
...
public class ObstacleManager {
    ...
    private void populateObstacles(){
        int currY = -5*Constant.SCREEN_HEIGHT/7;
        while(currY <0){
    ...
    public void update(){
        ...
        if(obstacles.get(obstacles.size()-1).getRectangle().top >=Constant.SCREEN_WIDTH){
            int xStart = (int) (Math.random()*(Constant.SCREEN_WIDTH - playerGap));
    ...
    public void draw(Canvas canvas){
        ...
        canvas.drawText("Current Score " + score, 50,100,paint );
    }
}
